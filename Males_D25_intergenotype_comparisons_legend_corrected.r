#Comparisons between genotpyes of D25 males
...
MachosD25 <- read_excel("MachosD25.xlsx")     

# Generate vectors with data                                                                         
w1118 <- MachosD25$w1118
prtpΔ1 <- MachosD25$prtpΔ1
parkina <- MachosD25$parkina
prtpΔ1parkina <- MachosD25$prtpΔ1parkina
...
write.xlsx(results, "levene_results_MachosD25.xlsx" , sheetName = "Results", rowNames = FALSE)
